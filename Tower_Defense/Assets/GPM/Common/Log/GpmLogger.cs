...
namespace Gpm.Common.Log
{
    public static class GpmLogger
    {
        ...
        /// 3. 데이터 로그
        /// </summary>
        public static void Debug(object message, string serviceName, Type classType, [CallerMemberName] string methodName = "")
        {
        ...
        /// </summary>
        public static void Warn(object message, string serviceName, Type classType, [CallerMemberName] string methodName = "")
        {
        ...
        /// </summary>
        public static void Error(object message, string serviceName, Type classType, [CallerMemberName] string methodName = "")
        {
